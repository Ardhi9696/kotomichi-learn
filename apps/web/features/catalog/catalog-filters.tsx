import { CONTENT_TYPES, LEVELS, type CatalogQuery } from '@/features/catalog/types';
...
export function CatalogFilters({ query }: { query: CatalogQuery }) {
  return (
    <form
      className="grid gap-4 rounded-2xl border border-border bg-surface p-4 shadow-[0_10px_35px_rgb(46_37_32_/_4%)] md:grid-cols-[1fr_auto_auto_auto] md:items-end"
      method="get"
    >
